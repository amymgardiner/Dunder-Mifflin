				...
				<div className="dropdown" onClick={toggleDropdown}>
					...
					<div className={`dropdown-content ${isDropdownVisible ? 'visible' : 'hidden'}`}>
						<div className="flex dropdown-content--text">
							<p className="mt-2 font-serif text-xl tracking-wider hvr-grow">Paper</p>
							<p className="mt-2 font-serif text-xl tracking-wider hvr-grow">Office Supplies</p>
							<p className="mt-2 font-serif text-xl tracking-wider hvr-grow">Printers & Copiers</p>
						</div>
					</div>
				</div>
			</div>
