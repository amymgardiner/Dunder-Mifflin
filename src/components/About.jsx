	...
	return (
		...
		<Navbar/>
			...
			<section className="py-32 md:py-20 wrapper about--grid-section">
				...
				<div className="px-16 pb-20 text-center md:pb-12 md:px-0">
					<h2 className="font-sans text-4xl font-semibold md:text-3xl">Our Story</h2>
					<p className="pt-8 text-2xl leading-loose font-default md:text-xl">Founded in 1949, Dunder Mifflin has a rich history of serving the paper needs of communities across the nation. From our humble beginnings as a local paper supplier, we've grown into a leading provider of paper and office products, with a presence in New Hampshire, New York, Ohio, and Pennsylvania. Over the years, we've adapted to the changing landscape of business and technology, but our core values remain the same: quality, reliability, and exceptional customer service.</p>
				</div>

				{/* cards */}
				<div className="grid grid-cols-3 gap-12 md:grid-cols-1">
					
					<div className="p-8 border-2 border-dark-blue rounded-2xl about--grid-card">
