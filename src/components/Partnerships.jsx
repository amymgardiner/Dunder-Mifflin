	...
	return (
		...
		<Navbar/>
			...
			<section className="wrapper">
				<div>
					<h2>Dunder Mifflin: Where partnership meets purpose.</h2>
				...
				<div>
					<h2>Local Business Collaborations</h2>
					<p>We're honored to work hand-in-hand with some of the finest local businesses, just as we're known for in the Scranton area. From "Alfredo's Pizza Cafe," where we celebrate great food, to "Poor Richard's Pub," where good times are always on tap, these partnerships bring us closer to the heart of Scranton.</p>
				</div>
				<div>
					<h2>A Sustainable Focus: Recycling Paper Partnerships</h2>
					<p>Dunder Mifflin is more than just a paper company; we're a steward of the environment. We proudly collaborate with recycling champions like "Hooters," who have demonstrated a commitment to sustainability through their innovative recycling programs. Together, we're reducing our carbon footprint, one sheet of paper at a time.</p>
				</div>
				<div>
					<h2>Community Support: Volunteering and Non-Profits</h2>
					<p>Giving back is a fundamental part of the Dunder Mifflin ethos. We actively engage with local non-profits such as "The Children's Hospital" and "The Michael Scott Foundation," dedicated to making a difference in the lives of children and families. Our team is also passionate about volunteering, whether it's cleaning up the local park or helping out at the "Golden Ticket Charity."</p>
				</div>
				<div>
					<h2>Innovative Collaborations</h2>
					<p>We're always seeking new and exciting partnerships to enhance our products and services. Whether it's joining forces with technology leaders to optimize our office solutions or partnering with educational institutions to empower the next generation, Dunder Mifflin remains at the forefront of innovation.</p>
				</div>
				<div>
					<h2>Join Us in Building a Brighter Future</h2>
					<p>As we continue to expand our network of partners, we invite you to be a part of our journey. Together, we can achieve remarkable things, support our community, and work towards a more sustainable and prosperous future. Contact us today to explore partnership opportunities that align with our values and your business objectives.</p>
				</div>
			</section>
