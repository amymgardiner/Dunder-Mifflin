...
const Navbar = () => {
	return (
		<footer className="flex justify-between px-16 py-8 bg-navy-blue lg:px-8 lg:flex-col lg:justify-center">
			...
			<div className="flex gap-20 lg:gap-8 lg:justify-center md:flex-col">
				<div className="flex flex-col md:text-center">
					<h2 className="mb-4 font-serif text-xl tracking-wider text-white uppercase">Contact</h2>
					<div className="flex flex-col">
						<p className="font-serif text-lg tracking-wider text-white">Phone: (570) 904-5026</p>
						<p className="font-serif text-lg tracking-wider text-white">Email: contact@dundermifflin.com</p>
					</div>
				</div>
				<div className="flex flex-col md:text-center">
					...
					<div className="flex flex-col">
						...
						<p className="font-serif text-lg tracking-wider text-white">(570) 904-5026</p>
					</div>
				</div>
				<div className="flex flex-col md:text-center">
				...
				<div className="flex flex-col md:text-center">
					...
					<div className="flex flex-wrap gap-8 lg:gap-4 md:justify-center">
